      ...
      <Stack spacing={4} padding={8}>
        <Stack spacing={2}>
          ...
          <Text as="samp" fontSize="xl">
            &nbsp;&nbsp;この利用規約（以下，「本規約」といいます。）は，Zumens（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
          </Text>
        </Stack>
        <Stack spacing={2}>
          <Text as="samp" fontSize="3xl">
        ...
        <Stack spacing={2}>
          ...
          <OrderedList pl={12}>
            <Text as="samp" fontSize="xl">
              <ListItem>ユーザーは，自己の責任において，本サービスのユーザーIDおよびパスワードを適切に管理するものとします。</ListItem>
            </Text>
            <Text as="samp" fontSize="xl">
              <ListItem>
        ...
        <Stack spacing={2}>
          ...
          <OrderedList pl={12}>
            ...
            <Text as="samp" fontSize="xl">
              <ListItem>ユーザーが利用料金の支払を遅滞した場合には，ユーザーは年14．6％の割合による遅延損害金を支払うものとします。</ListItem>
            </Text>
          </OrderedList>
        </Stack>
        <Stack spacing={2}>
          ...
          <OrderedList pl={12}>
            ...
            <Text as="samp" fontSize="xl">
              <ListItem>当社が許諾しない本サービス上での宣伝，広告，勧誘，または営業行為</ListItem>
            </Text>
            <Text as="samp" fontSize="xl">
        ...
        <Stack spacing={2}>
          ...
          <OrderedList pl={12}>
            ...
            <Text as="samp" fontSize="xl">
              <ListItem>当社は，本条に基づき当社が行った行為によりユーザーに生じた損害について，一切の責任を負いません。</ListItem>
            </Text>
          </OrderedList>
        </Stack>
        <Stack spacing={2}>
        ...
        <Stack spacing={2}>
          ...
          <OrderedList pl={12}>
            <Text as="samp" fontSize="xl">
              <ListItem>当社は以下の場合には、ユーザーの個別の同意を要せず、本規約を変更することができるものとします。</ListItem>
            </Text>
            <OrderedList pl={12}>
              <Text as="samp" fontSize="xl">
                <ListItem>本規約の変更がユーザーの一般の利益に適合するとき。</ListItem>
              </Text>
              <Text as="samp" fontSize="xl">
                <ListItem>
        ...
        <Stack spacing={2}>
          ...
          <OrderedList pl={12}>
            ...
            <Text as="samp" fontSize="xl">
              <ListItem>本サービスに関して紛争が生じた場合には，当社の本店所在地を管轄する裁判所を専属的合意管轄とします。</ListItem>
            </Text>
          </OrderedList>
        </Stack>
